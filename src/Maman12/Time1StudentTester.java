...
public class Time1StudentTester
{
    public static void main(String[] args) {
        ...
        System.out.println("********** Test Time1 - Started **********");

        //=====================================================================
        System.out.println("\n\n1. Testing Constructors and toString:");
        System.out.println("\n\t1. Testing Constructor with 3 parameters Time1(int h, int m, int s):");
        Time1 t1 = new Time1(10,25,40);
        System.out.println("\tTime1 t1 is: (should be: 10:25:40)\n\t"+ t1);
        System.out.println("\n\t2. Testing Copy Constructor Time1(Time1 other):");
        Time1 t2 = new Time1(t1);
        System.out.println("\tTime1 t2 (constructed using t1) is: (should be 10:25:40)\n\t"+ t2);
        ...
        t1= new Time1(10,25,40);
        System.out.println("\n\tTime1 t1 is:\n\t"+ t1);
        t2= new Time1(10,25,40);
        System.out.println("\n\tTime1 t2 is:\n\t"+ t2);
        System.out.println("\n\tTest results (t1.equals(t2)):");
        if(t1.equals(t2))
            System.out.println("\tPassed: Time t1 is the same Time1 as t2");
        else 
        ...
        t1= new Time1(10,25,40);
        System.out.println("\n\tTime1 t1 is:\n\t"+ t1);
        t2= new Time1(10,40,45);
        System.out.println("\n\tTime1 t2 is:\n\t"+ t2);
        System.out.println("\n\tTest results: (t1.before(t2))");
        if(t1.before(t2))
            System.out.println("\tPassed: Time1 t1 (10:25:40) is before Time2 t2 (10:40:45)");
        else 
        ...
        if(t2.after(t1))
            System.out.println("\tPassed: Time2 t2 (10:40:45) is after time1 t1 (10:25:40)");
        else 
